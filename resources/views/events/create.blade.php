            ...
            >
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" id="title" name="title" class="bg-gray-700 text-gray-300 text-sm rounded-lg border-transparent focus:border-transparent focus:ring-0" placeholder="Laravel Event">
                            ...
                            @foreach ($tags as $tag)
                                <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                                    <div class="flex items-center pl-3">
                                        <input type="checkbox" name="vue-checkbox-list" id="vue-checkbox-list" type="checkbox" name="tags[]" value="{{ $tag->id }}" class="w-4 h-4">
                                        <label for="vue-checkbox-list" class="w-full py-3 ml-2 text-sm font-medium text-gray-900 dark:text-white"></label>
                                    </div>
                                </li>
                            @endforeach
                        </ul>
                    ...
                    <div>
                        <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 font-medium rounded px-4 py-2">Submit</button>
                    </div>
