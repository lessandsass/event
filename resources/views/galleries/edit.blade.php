    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            >
                ...
                @method('PUT')
                    ...
                    <div>
                        ...
                        <input
                            ...
                            id="caption"
                            name="caption"
                            class="bg-gray-700 text-gray-300 text-sm rounded-lg border-transparent focus:border-transparent focus:ring-0 w-full py-3"
                ...
                <div>
                    <button type="submit" class="mt-5 block text-white bg-blue-700 hover:bg-blue-800 font-medium rounded px-4 py-2">Update</button>
                </div>
