<x-main-layout>
    ...
    <div class="m-2 p-2 flex justify-between">
        ...
        <div class="space-x-2 text-gray-400 block">
            From:
            <span class="mx-2">{{ $event->toArray()['start_date'] }}</span> | <span
                class="mx-2">{{ $event->start_time }}</span>
        </div>
    </div>
    ...
    <div class="mb-16 flex flex-wrap">
        <div class="mb-6 w-full shrink-0 grow-0 basis-auto lg:mb-0 lg:w-6/12 lg:pr-6">
            <div class="flex flex-col">
                ...
                @auth
                    ...
                    >
                        ...
                        <button
                            ...
                            :class="eventLike ? 'dark:bg-red-700 dark:hover:bg-red-800' : 'dark:bg-slate-400 dark:hover:bg-slate-500'"
                        >
                ...
                <div class="flex flex-col p-4">
                    ...
                    <div class="flex space-x-4 mt-6 bg-slate-200 dark:bg-slate-700 dark:text-slate-400 p-2 rounded-md">
                        <span>
        ...
        <div class="w-full shrink-0 grow-0 lg:w-6/12 lg:pl-6 bg-slate-50 dark:bg-slate-800 rounded-md p-2">
